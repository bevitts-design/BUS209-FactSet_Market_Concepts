...
assessments = [
    ("Country Economic Indicators & Markets", "20%"), ("Equities / Pitch Book", "20%"),
    ("Credit Analysis Presentation", "20%"), ("Final Presentation", "20%"),
    ("FactSet Certifications", "10%"), ("Attendance / Participation", "10%"),
]
...
def build_docx():
    ...
    add_heading(d,'Evaluation Methods'); d.add_paragraph('Student learning will be assessed through the following. Core section deliverables and presentations account for 80%; FactSet Certifications account for 10%; and logistics, timeliness, preparedness, attendance, and participation account for 10%.')
...
def build_html():
    ...
    <section id="assessment"><h2>Evaluation & Grading</h2><p>Student learning will be assessed through core section deliverables and presentations (80%), FactSet Certifications (10%), and logistics, timeliness, preparedness, attendance, and participation (10%). For the four core sections, each student or group—depending on class size—will demonstrate proficiency using the FactSet terminal to access and explain relevant financial information. Deliverables include PowerPoint submissions and verbal class presentations using the FactSet terminal.</p><div class="weights">{assess_html}</div><h3>Letter Grade Scale</h3><div class="grades">{grades_html}</div></section>
