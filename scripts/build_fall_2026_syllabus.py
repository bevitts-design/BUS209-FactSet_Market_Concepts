...
schedule = [
    ...
    (9,"November 9","To Be determined","class"),
    (10,"November 16","To Be determined","class"),
...
def build_html():
    ...
    <section id="schedule"><h2>Topic Outline & Timeline</h2><p>This is a rough guide. Starting in Week 1, you have something due almost every week. Changes will be announced via Canvas; check it at least once per day.</p><table><thead><tr><th>Week</th><th>Week of</th><th>Assignments Due / Weekly Class Topics</th></tr></thead><tbody>{schedule_html}</tbody></table><p><small>Fall 2026 calendar alignment: classes begin September 1; Thanksgiving recess begins after November 20; classes resume November 30; regular classes end December 11; finals run December 14–18.</small></p></section>
